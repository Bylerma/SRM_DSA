...
![Difficulty: Hard](https://img.shields.io/badge/Difficulty-Hard-red) ![Tag: String](https://img.shields.io/badge/Tag-String-blue) ![Tag: Simulation](https://img.shields.io/badge/Tag-Simulation-blue)

## 🔗 Link
[LeetCode Problem URL](https://leetcode.com/problems/process-string-with-special-operations-ii/)
